...
<form id="usualValidate" class="form-horizontal" method="post" action="<?=base_url()?>admin/slider/modifySlide/<?=$slide->id?>">
	<fieldset>
		<div class="block well">
			<div class="row-fluid">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span12" name="url" id="" value="<?=$slide->url?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("photo_url")?>: <span class="req">*</span></label>
					<div class="controls">
						<div class="input-append"><input type="text" class="required span12" name="photo_url" id="photo_url" value="<?=$slide->photo_url?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
