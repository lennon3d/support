	...
	<fieldset>
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append"><input type="text" class="required span12" name="photo_url_<?=$row->lang?>" id="photo_url_<?=$row->lang?>" value="<?=$row->photo_url?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php foreach($langs as $lang){?>
							<option value="<?=$lang->code?>" <?=set_select("lang",$lang->code);?> <?=($lang->code==$row->lang?"selected='selected'":"")?>><?=$lang->language?></option>
						<?php }?>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<option <?=($row->position=="right"?"selected='selected'":"")?> value="right"><?=lang("right")?></option>
						<option <?=($row->position=="left"?"selected='selected'":"")?> value="left"><?=lang("left")?></option>
						</select>
					</div>
				</div>
