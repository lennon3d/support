		...
		<div class="block well">
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="photo_url_<?=$lang->code?>" id="photo_url_<?=$lang->code?>" value="<?=$post["photo_url_$lang->code"]?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				</div>
				<!-- 
				<div class="control-group">
