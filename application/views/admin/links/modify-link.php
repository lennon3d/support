		...
		<div class="block well">
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					<label class="control-label"><?=lang("link_title")?>: <span class="req">*</span></label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="photo_url_<?=$row->lang?>" id="photo_url_<?=$row->lang?>" value="<?=$row->photo_url?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				</div>
				<!-- 
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php foreach($langs as $lang){?>
							<option value="<?=$lang->code?>" <?=set_select("lang",$lang->code);?> <?=($lang->code==$link->lang?"selected='selected'":"")?>><?=$lang->language?></option>
						<?php }?>
						</select>
					</div>
				</div>	
				-->	
				<div class="control-group">
					<label class="control-label"><?=lang("link_url")?>: </label>
					<div class="controls">
						<input type="text" class="span12" name="url_<?=$row->lang?>" id="" value="<?=$row->url?>"/>
					</div>
				</div>
