...
<form id="usualValidate" class="form-horizontal" method="post" action="<?=base_url()?>admin/videos/insertVideo">
	<fieldset>
		<div class="block well">
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					<label class="control-label"><?=lang("video_title")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="title_<?=$lang->code?>" id="" value="<?=$post["title_$lang->code"]?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("video_desc")?>: </label>
					<div class="controls">
				...
				<div class="control-group">
					<label class="control-label"><?=lang("video_thumb")?>: </label>
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="thumb_url_<?=$lang->code?>" id="thumb_text_<?=$lang->code?>" value="<?=$post["thumb_url_$lang->code"]?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("video_url")?>: </label>
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="video_url_<?=$lang->code?>" value="<?=$post["video_url_$lang->code"]?>" /></div>
					</div>
				</div>
				<div class="control-group">
