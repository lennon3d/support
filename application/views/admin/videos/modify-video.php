		...
		<div class="block well">
			<div class="row-fluid">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="thumb_url_<?=$row->lang?>" id="thumb_text_<?=$row->lang?>" value="<?=$row->thumb_url?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("video_url")?>: </label>
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="video_url_<?=$row->lang?>" value="<?=$row->video_url?>" /></div>
					</div>
				</div>
				<!-- 
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php foreach($langs as $lang){?>
							<option value="<?=$lang->code?>" <?=($lang->code==$video->lang?"selected='selected'":"")?>><?=$lang->language?></option>
						<?php }?>
						</select>
					</div>
				</div>	
