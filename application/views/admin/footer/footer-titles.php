<form id="usualValidate" class="form-horizontal" method="post" action="<?=base_url()?>admin/footer/updateTitles">
	<fieldset>
			...
			<div class="row-fluid">
				<div class="tabbable">
					...
					<?php foreach($langs as $lang){?>
						...
						<?php if($footer_titles){?>
						<?php foreach($footer_titles as $title){?>
