		...
		<div class="block well">
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append"><input type="text" class="required span12" name="thumb_<?=$row->lang?>" id="thumb_<?=$row->lang?>" value="<?=$row->thumb?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
