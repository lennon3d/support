		...
		<div class="block well">
			...
			<div class="tab-pane" id="other_tab">
				...
				<div class="control-group">
					<label class="control-label"><?=lang("sponsor_title")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="title_<?=$lang->code?>" id="" value="<?=$post["title_$lang->code"]?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("sponsor_thumb")?>: <span class="req">*</span></label>
					<div class="controls">
						<div class="input-append"><input type="text" class="required span12" name="thumb_<?=$lang->code?>" id="thumb_<?=$lang->code?>" value="<?=$post["thumb_$lang->code"]?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("sponsor_url")?>: </label>
					<div class="controls">
						<input type="text" class="span12" name="url_<?=$lang->code?>" id="" value="<?= $post["url_$lang->code"] ?>"/>
					</div>
				</div>
				<div class="control-group">
