...
<form id="usualValidate" class="form-horizontal" method="post" action="<?=base_url()?>admin/products/modifyProduct/<?=$product->id?>">
	<fieldset>
		<div class="block well">
			<div class="row-fluid">
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php foreach($cats as $cat){?>
							<option value="<?=$cat->id?>" <?=($product->category==$cat->id?"selected='selected'":"")?> ><?=$cat->title?></option>
						<?php }?>
						</select>
					</div>
				</div>	
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="required span12" name="title" id="username_text" value="<?=$product->title?>"/>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("product_subtitle")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="subtitle" id="" value="<?=$product->subtitle?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("year")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="year" id="" value="<?=$product->year?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("director")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="director" id="" value="<?=$product->director?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("editor")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="editor" id="" value="<?=$product->editor?>" />
					</div>
				</div>	
				<div class="control-group">
					<label class="control-label"><?=lang("actors")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="actors" id="" value="<?=$product->actors?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("country")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="country" id="" value="<?=$product->country?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("copyrights")?>: <span class="req">*</span></label>
					<div class="controls">
						<input type="text" class="required span12" name="copyrights" id="" value="<?=$product->copyrights?>" />
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("description")?>: <span class="req">*</span></label>
					<div class="controls">
						<textarea class="required span12" name="description" id="" ><?=$product->description?></textarea>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("product_thumb")?>: <span class="req">*</span></label>
					<div class="controls">
						<div class="input-append"><input type="text" class="span12" name="thumb" id="thumb" value="<?=$product->thumb?>" /><a class="btn open_elfinder" data-toggle="modal" href="#elfinder_dialog"><b class="font-folder-open"></b></a></div>
					</div>
				</div>		
				<div class="control-group">
					<label class="control-label"><?=lang("in_slider")?>: </label>
					<div class="controls on_off">
						<div class="checkbox inline"><input type="checkbox" id="check20" <?=($product->in_slider=="1"?"checked='checked'":"")?> name="in_slider" /></div>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?=lang("active")?>: </label>
					<div class="controls on_off">
						<div class="checkbox inline"><input <?=($product->active=="1"?"checked='checked'":"")?> type="checkbox" id="check20"  name="active" /></div>
					</div>
				</div>	
				<!-- 
				<div class="control-group">
					...
					<div class="controls">
						...
						<?php foreach($langs as $lang){?>
							<option value="<?=$lang->code?>" <?=set_select("lang",$lang->code);?> <?=($lang->code==$product->lang?"selected='selected'":"")?>><?=$lang->language?></option>
						<?php }?>
						</select>
					</div>
				</div>			
